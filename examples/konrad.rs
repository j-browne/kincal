...
use kincal::{
    ReactionKinematics,
    Value::{NoVal, OneVal, TwoVal},
    Outgoing::{Ejectile, Recoil},
};
...
fn main() {
    ...
    let m = match beam.as_str() {
        "34S" => [33.967_867_012 * 931.494_095, 4.001_506_179 * 931.494_095, 1.007_276_469 * 931.494_095, 36.965_902_584 * 931.494_095 + e_ex],
        "34Cl" => [33.973_762_491 * 931.494_095, 4.001_506_179 * 931.494_095, 1.007_276_469 * 931.494_095, 36.966_776_314 * 931.494_095 + e_ex],
        "34Ar" => [33.970_409_992 * 931.494_095, 4.001_506_179 * 931.494_095, 1.007_276_469 * 931.494_095, 36.962_969_140 * 931.494_095 + e_ex],
